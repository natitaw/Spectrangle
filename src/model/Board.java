...
public class Board {
    ...
    public boolean isValidColor(int location, Piece piece) {
        ...
        if (left != null) {
            ...
            if (!d.equals(c) && !left.isJoker() && !piece.isJoker()) {
                return false;
            }
        ...
        if (right != null) {
            ...
            if (!d.equals(c) && !right.isJoker() && !piece.isJoker()) {
                return false;
            }
        ...
        if (top != null) {
            ...
            if (!d.equals(c) && !top.isJoker() && !piece.isJoker()) {
                return false;
            }
        ...
        if (bottom != null) {
            ...
            if (!d.equals(c) && !bottom.isJoker() && !piece.isJoker()) {
                return false;
            }
